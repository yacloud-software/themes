...
func (m *ActiveUpdate) GetRepository() uint32 {
	if m != nil {
		return m.Repository
	}
	return 0
...
func (*ComReceived) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*UpdateStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*UpdateStatusList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
type FirmwareInfo struct {
	...
	Repository uint32                `protobuf:"varint,2,opt,name=Repository" json:"Repository,omitempty"`
...
func (*FirmwareInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (m *FirmwareInfo) GetRepository() uint32 {
	if m != nil {
		return m.Repository
	}
	return 0
...
func (*HistoryList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*History) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*UpgradeRepoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
var fileDescriptor0 = []byte{
	...
	,
}
