...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3124 // indirect
	golang.conradwood.net/apis/autodeployer v1.1.3071 // indirect
	golang.conradwood.net/apis/common v1.1.3124 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.3124 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3124 // indirect
